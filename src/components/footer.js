  ...
  return (
    <div className='footer-container'>
        <section className='footer'>
            ...
            <br/>
            <p className='footer-builtby'>Made with <input type="checkbox" class="checkbox" id="checkbox" />{heart_svg} by <a href="https://www.theshekharmaharaj.com">Shekhar Maharaj</a>
            </p>
        </section>
    </div>
  )
